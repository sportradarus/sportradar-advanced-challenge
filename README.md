...
* The second process should only run when games are live. It should close when games are over. This process will ingest data from the NHL feed based on game:
  * Player ID
  * Player Name
  * Team ID
  * Team Name
